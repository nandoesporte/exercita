...
-- Criar tabela de produtos para habilitar gerenciamento completo
...
-- Verificar se precisamos criar a tabela user_workout_history (já existe conforme esquema)
-- Apenas garantir que tenha os triggers necessários
CREATE TRIGGER IF NOT EXISTS update_user_workout_history_updated_at
