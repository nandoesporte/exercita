-- Primeiro fazer DROP da função e depois recriar com nome de parâmetro correto
DROP FUNCTION IF EXISTS public.toggle_user_admin_status(uuid, boolean);

-- Recriar função com nome de parâmetro diferente para evitar ambiguidade
...
BEGIN
    ...
    -- Get current admin status and email (usando aliases explícitos para evitar ambiguidade)
