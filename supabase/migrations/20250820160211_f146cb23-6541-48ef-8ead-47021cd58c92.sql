...
ALTER FUNCTION public.admin_enable_rls(text) SET search_path = public;
ALTER FUNCTION public.get_all_users() SET search_path = public;
ALTER FUNCTION public.toggle_user_active_status(uuid, boolean) SET search_path = public;
ALTER FUNCTION public.get_tables_without_rls() SET search_path = public;
ALTER FUNCTION public.admin_create_user(text, text, jsonb) SET search_path = public;