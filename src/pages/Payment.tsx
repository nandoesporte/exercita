  ...
  useEffect(() => {
    const fetchPaymentData = async () => {
      ...
      try {
        ...
        // For now, we'll use static data that would have been set in the admin panel
        setPixKey('exemplo@email.com');
        setPixKeyType('email');
        setMonthlyFee('99.90');
        ...
        // const { data: pixData } = await supabase.from('payment_settings').select('*').single();
